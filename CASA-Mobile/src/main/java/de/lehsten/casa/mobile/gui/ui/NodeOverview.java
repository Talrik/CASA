...
public class NodeOverview extends NavigationView {
	...
	private void buildView() { 
		...
		for(Node n : nodes){
			content.addComponent(buildNodeOverview(n));
		}
		
		VerticalComponentGroup addExternalNodes = new VerticalComponentGroup();
		addExternalNodes.setCaption("External nodes");
		addExternalNodes.addComponent(new Label("Add external nodes"));
		NavigationButton b = new NavigationButton("   By URL");
		addExternalNodes.addComponent(b);
		content.addComponent(addExternalNodes);
...
*/
	...
	private VerticalComponentGroup buildNodeOverview(Node n){
...
//TODO							CASAUI.getApp().getNodeHandler().updateNode(n, n);
					}else{
