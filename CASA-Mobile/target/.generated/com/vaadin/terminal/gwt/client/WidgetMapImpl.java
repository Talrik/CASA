...
public class WidgetMapImpl extends com.vaadin.terminal.gwt.client.WidgetMap {
  public Class<? extends Paintable> getImplementationByServerSideClassName(String fullyQualifiedName) {
    ...
    if ( fullyQualifiedName == "com.vaadin.ui.HorizontalSplitPanel" ) { ensureInstantiator(com.vaadin.terminal.gwt.client.ui.VSplitPanelHorizontal.class); return com.vaadin.terminal.gwt.client.ui.VSplitPanelHorizontal.class;}
    ...
    else if ( fullyQualifiedName == "org.vaadin.vol.MarkerLayer" ) { ensureInstantiator(org.vaadin.vol.client.ui.VMarkerLayer.class); return org.vaadin.vol.client.ui.VMarkerLayer.class;}
    ...
    else if ( fullyQualifiedName == "org.vaadin.vol.WebMapServiceLayerStyled" ) { ensureInstantiator(org.vaadin.vol.client.ui.VWebMapServiceLayerStyled.class); return org.vaadin.vol.client.ui.VWebMapServiceLayerStyled.class;}
    ...
    else if ( fullyQualifiedName == "org.vaadin.vol.WebFeatureServiceLayer" ) { ensureInstantiator(org.vaadin.vol.client.ui.VWebFeatureServiceLayer.class); return org.vaadin.vol.client.ui.VWebFeatureServiceLayer.class;}
    else if ( fullyQualifiedName == "org.vaadin.vol.PolyLine" ) { ensureInstantiator(org.vaadin.vol.client.ui.VPolyLine.class); return org.vaadin.vol.client.ui.VPolyLine.class;}
    ...
    else if ( fullyQualifiedName == "org.vaadin.vol.MapTilerLayer" ) { ensureInstantiator(org.vaadin.vol.client.ui.VMapTilerLayer.class); return org.vaadin.vol.client.ui.VMapTilerLayer.class;}
    ...
    else if ( fullyQualifiedName == "org.vaadin.vol.YahooMapLayer" ) { ensureInstantiator(org.vaadin.vol.client.ui.VYahooMapLayer.class); return org.vaadin.vol.client.ui.VYahooMapLayer.class;}
    ...
    else if ( fullyQualifiedName == "org.vaadin.vol.VectorLayer" ) { ensureInstantiator(org.vaadin.vol.client.ui.VVectorLayer.class); return org.vaadin.vol.client.ui.VVectorLayer.class;}
    ...
    else if ( fullyQualifiedName == "org.vaadin.vol.OpenStreetMapCycleLayer" ) { ensureInstantiator(org.vaadin.vol.client.ui.VOpenStreetMapCycleLayer.class); return org.vaadin.vol.client.ui.VOpenStreetMapCycleLayer.class;}
    else if ( fullyQualifiedName == "org.vaadin.vol.Popup" ) { ensureInstantiator(org.vaadin.vol.client.ui.VPopup.class); return org.vaadin.vol.client.ui.VPopup.class;}
    ...
    else if ( fullyQualifiedName == "org.vaadin.vol.WebMapServiceLayer" ) { ensureInstantiator(org.vaadin.vol.client.ui.VWebMapServiceLayer.class); return org.vaadin.vol.client.ui.VWebMapServiceLayer.class;}
    ...
    else if ( fullyQualifiedName == "org.vaadin.vol.Marker" ) { ensureInstantiator(org.vaadin.vol.client.ui.VMarker.class); return org.vaadin.vol.client.ui.VMarker.class;}
    ...
    else if ( fullyQualifiedName == "org.vaadin.vol.ImageLayer" ) { ensureInstantiator(org.vaadin.vol.client.ui.VImageLayer.class); return org.vaadin.vol.client.ui.VImageLayer.class;}
    ...
    else if ( fullyQualifiedName == "org.vaadin.vol.BingMapLayer" ) { ensureInstantiator(org.vaadin.vol.client.ui.VBingMapLayer.class); return org.vaadin.vol.client.ui.VBingMapLayer.class;}
    else if ( fullyQualifiedName == "org.vaadin.vol.GoogleStreetMapLayer" ) { ensureInstantiator(org.vaadin.vol.client.ui.VGoogleStreetMapLayer.class); return org.vaadin.vol.client.ui.VGoogleStreetMapLayer.class;}
    else if ( fullyQualifiedName == "org.vaadin.vol.GoogleTerrainMapLayer" ) { ensureInstantiator(org.vaadin.vol.client.ui.VGoogleTerrainMapLayer.class); return org.vaadin.vol.client.ui.VGoogleTerrainMapLayer.class;}
    else if ( fullyQualifiedName == "org.vaadin.vol.EmptyLayer" ) { ensureInstantiator(org.vaadin.vol.client.ui.VEmptyLayer.class); return org.vaadin.vol.client.ui.VEmptyLayer.class;}
    else if ( fullyQualifiedName == "org.vaadin.vol.Area" ) { ensureInstantiator(org.vaadin.vol.client.ui.VArea.class); return org.vaadin.vol.client.ui.VArea.class;}
    ...
    else if ( fullyQualifiedName == "org.vaadin.vol.OpenStreetMapLayer" ) { ensureInstantiator(org.vaadin.vol.client.ui.VOpenStreetMapLayer.class); return org.vaadin.vol.client.ui.VOpenStreetMapLayer.class;}
    ...
    else if ( fullyQualifiedName == "org.vaadin.vol.GoogleSatelliteMapLayer" ) { ensureInstantiator(org.vaadin.vol.client.ui.VGoogleSatelliteMapLayer.class); return org.vaadin.vol.client.ui.VGoogleSatelliteMapLayer.class;}
    ...
    else if ( fullyQualifiedName == "org.vaadin.vol.OpenLayersMap" ) { ensureInstantiator(org.vaadin.vol.client.ui.VOpenLayersMap.class); return org.vaadin.vol.client.ui.VOpenLayersMap.class;}
    ...
    else if ( fullyQualifiedName == "org.vaadin.vol.PointVector" ) { ensureInstantiator(org.vaadin.vol.client.ui.VPointVector.class); return org.vaadin.vol.client.ui.VPointVector.class;}
    else if ( fullyQualifiedName == "org.vaadin.vol.GoogleHybridMapLayer" ) { ensureInstantiator(org.vaadin.vol.client.ui.VGoogleHybridMapLayer.class); return org.vaadin.vol.client.ui.VGoogleHybridMapLayer.class;}
    ...
    else if ( fullyQualifiedName == "org.vaadin.vol.VirtualEarthMapLayer" ) { ensureInstantiator(org.vaadin.vol.client.ui.VVirtualEarthMapLayer.class); return org.vaadin.vol.client.ui.VVirtualEarthMapLayer.class;}
    ...
    else if ( fullyQualifiedName == "org.vaadin.vol.WellKnownTextLayer" ) { ensureInstantiator(org.vaadin.vol.client.ui.VWellKnownTextLayer.class); return org.vaadin.vol.client.ui.VWellKnownTextLayer.class;}
  ...
  if( classType == com.vaadin.terminal.gwt.client.ui.VSplitPanelHorizontal.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
...
} else if( classType == org.vaadin.vol.client.ui.VMarkerLayer.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VMarkerLayer.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VMarkerLayer.class );
  }
  }
  );}});
...
);} else if( classType == org.vaadin.vol.client.ui.VWebMapServiceLayerStyled.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VWebMapServiceLayerStyled.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VWebMapServiceLayerStyled.class );
  }
  }
  );}});
...
);} else if( classType == org.vaadin.vol.client.ui.VWebFeatureServiceLayer.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VWebFeatureServiceLayer.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VWebFeatureServiceLayer.class );
  }
  }
  );}});
} else if( classType == org.vaadin.vol.client.ui.VPolyLine.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VPolyLine.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VPolyLine.class );
  }
  }
  );}});
...
} else if( classType == org.vaadin.vol.client.ui.VMapTilerLayer.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VMapTilerLayer.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VMapTilerLayer.class );
  }
  }
  );}});
...
} else if( classType == org.vaadin.vol.client.ui.VYahooMapLayer.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VYahooMapLayer.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VYahooMapLayer.class );
  }
  }
  );}});
...
} else if( classType == org.vaadin.vol.client.ui.VVectorLayer.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VVectorLayer.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VVectorLayer.class );
  }
  }
  );}});
...
} else if( classType == org.vaadin.vol.client.ui.VOpenStreetMapCycleLayer.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VOpenStreetMapCycleLayer.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VOpenStreetMapCycleLayer.class );
  }
  }
  );}});
} else if( classType == org.vaadin.vol.client.ui.VPopup.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VPopup.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VPopup.class );
  }
  }
  );}});
...
} else if( classType == org.vaadin.vol.client.ui.VWebMapServiceLayer.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VWebMapServiceLayer.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VWebMapServiceLayer.class );
  }
  }
  );}});
...
} else if( classType == org.vaadin.vol.client.ui.VMarker.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VMarker.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VMarker.class );
  }
  }
  );}});
...
} else if( classType == org.vaadin.vol.client.ui.VImageLayer.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VImageLayer.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VImageLayer.class );
  }
  }
  );}});
...
);} else if( classType == org.vaadin.vol.client.ui.VBingMapLayer.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VBingMapLayer.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VBingMapLayer.class );
  }
  }
  );}});
} else if( classType == org.vaadin.vol.client.ui.VGoogleStreetMapLayer.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VGoogleStreetMapLayer.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VGoogleStreetMapLayer.class );
  }
  }
  );}});
} else if( classType == org.vaadin.vol.client.ui.VGoogleTerrainMapLayer.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VGoogleTerrainMapLayer.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VGoogleTerrainMapLayer.class );
  }
  }
  );}});
} else if( classType == org.vaadin.vol.client.ui.VEmptyLayer.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VEmptyLayer.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VEmptyLayer.class );
  }
  }
  );}});
} else if( classType == org.vaadin.vol.client.ui.VArea.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VArea.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VArea.class );
  }
  }
  );}});
...
} else if( classType == org.vaadin.vol.client.ui.VOpenStreetMapLayer.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VOpenStreetMapLayer.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VOpenStreetMapLayer.class );
  }
  }
  );}});
...
} else if( classType == org.vaadin.vol.client.ui.VGoogleSatelliteMapLayer.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VGoogleSatelliteMapLayer.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VGoogleSatelliteMapLayer.class );
  }
  }
  );}});
...
} else if( classType == org.vaadin.vol.client.ui.VOpenLayersMap.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VOpenLayersMap.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VOpenLayersMap.class );
  }
  }
  );}});
...
} else if( classType == org.vaadin.vol.client.ui.VPointVector.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VPointVector.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VPointVector.class );
  }
  }
  );}});
} else if( classType == org.vaadin.vol.client.ui.VGoogleHybridMapLayer.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VGoogleHybridMapLayer.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VGoogleHybridMapLayer.class );
  }
  }
  );}});
...
} else if( classType == org.vaadin.vol.client.ui.VVirtualEarthMapLayer.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VVirtualEarthMapLayer.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VVirtualEarthMapLayer.class );
  }
  }
  );}});
...
);} else if( classType == org.vaadin.vol.client.ui.VWellKnownTextLayer.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
  new WidgetLoader() { void addInstantiator() {instmap.put(org.vaadin.vol.client.ui.VWellKnownTextLayer.class,new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(org.vaadin.vol.client.ui.VWellKnownTextLayer.class );
  }
  }
  );}});
