...
public class AsyncLoader50 {
// Callbacks that are pending
private static AsyncLoader50__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader50__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader50 instance = null;
public static void onLoad() {
instance = new AsyncLoader50();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(50);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks50", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks50", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader50__Callback newCallback = new AsyncLoader50__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(50)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(50,
...
while (callbacksHead != null) {
  ...
  AsyncLoader50__Callback next = callbacksHead;
