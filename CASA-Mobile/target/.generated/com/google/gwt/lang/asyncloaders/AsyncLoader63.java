...
public class AsyncLoader63 {
// Callbacks that are pending
private static AsyncLoader63__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader63__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader63 instance = null;
public static void onLoad() {
instance = new AsyncLoader63();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(63);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks63", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks63", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader63__Callback newCallback = new AsyncLoader63__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(63)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(63,
...
while (callbacksHead != null) {
  ...
  AsyncLoader63__Callback next = callbacksHead;
