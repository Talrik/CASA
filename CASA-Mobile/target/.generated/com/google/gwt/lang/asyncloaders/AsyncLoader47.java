...
public class AsyncLoader47 {
// Callbacks that are pending
private static AsyncLoader47__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader47__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader47 instance = null;
public static void onLoad() {
instance = new AsyncLoader47();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(47);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks47", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks47", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader47__Callback newCallback = new AsyncLoader47__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(47)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(47,
...
while (callbacksHead != null) {
  ...
  AsyncLoader47__Callback next = callbacksHead;
