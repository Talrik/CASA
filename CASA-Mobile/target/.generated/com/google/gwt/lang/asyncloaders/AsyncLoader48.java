...
public class AsyncLoader48 {
// Callbacks that are pending
private static AsyncLoader48__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader48__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader48 instance = null;
public static void onLoad() {
instance = new AsyncLoader48();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(48);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks48", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks48", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader48__Callback newCallback = new AsyncLoader48__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(48)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(48,
...
while (callbacksHead != null) {
  ...
  AsyncLoader48__Callback next = callbacksHead;
