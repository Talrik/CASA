...
public class AsyncLoader46 {
// Callbacks that are pending
private static AsyncLoader46__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader46__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader46 instance = null;
public static void onLoad() {
instance = new AsyncLoader46();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(46);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks46", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks46", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader46__Callback newCallback = new AsyncLoader46__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(46)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(46,
...
while (callbacksHead != null) {
  ...
  AsyncLoader46__Callback next = callbacksHead;
