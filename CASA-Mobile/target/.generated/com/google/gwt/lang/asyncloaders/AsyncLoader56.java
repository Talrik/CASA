...
public class AsyncLoader56 {
// Callbacks that are pending
private static AsyncLoader56__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader56__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader56 instance = null;
public static void onLoad() {
instance = new AsyncLoader56();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(56);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks56", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks56", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader56__Callback newCallback = new AsyncLoader56__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(56)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(56,
...
while (callbacksHead != null) {
  ...
  AsyncLoader56__Callback next = callbacksHead;
