...
public class AsyncLoader62 {
// Callbacks that are pending
private static AsyncLoader62__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader62__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader62 instance = null;
public static void onLoad() {
instance = new AsyncLoader62();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(62);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks62", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks62", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader62__Callback newCallback = new AsyncLoader62__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(62)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(62,
...
while (callbacksHead != null) {
  ...
  AsyncLoader62__Callback next = callbacksHead;
