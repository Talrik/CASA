...
public class AsyncLoader55 {
// Callbacks that are pending
private static AsyncLoader55__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader55__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader55 instance = null;
public static void onLoad() {
instance = new AsyncLoader55();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(55);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks55", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks55", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader55__Callback newCallback = new AsyncLoader55__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(55)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(55,
...
while (callbacksHead != null) {
  ...
  AsyncLoader55__Callback next = callbacksHead;
