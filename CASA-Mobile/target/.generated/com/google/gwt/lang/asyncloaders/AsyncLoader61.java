...
public class AsyncLoader61 {
// Callbacks that are pending
private static AsyncLoader61__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader61__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader61 instance = null;
public static void onLoad() {
instance = new AsyncLoader61();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(61);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks61", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks61", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader61__Callback newCallback = new AsyncLoader61__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(61)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(61,
...
while (callbacksHead != null) {
  ...
  AsyncLoader61__Callback next = callbacksHead;
