...
public class AsyncLoader52 {
// Callbacks that are pending
private static AsyncLoader52__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader52__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader52 instance = null;
public static void onLoad() {
instance = new AsyncLoader52();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(52);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks52", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks52", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader52__Callback newCallback = new AsyncLoader52__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(52)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(52,
...
while (callbacksHead != null) {
  ...
  AsyncLoader52__Callback next = callbacksHead;
