...
public class SemanticRuleTest_StudIPRequestHandler {
  ...
  public boolean accept(Activation activation) {
	...
	public void QueryTest_HandleJsonStudIPRequests() {
		...
		System.out.println(studipRequest instanceof StudIPRequest);
		System.out.println(studipRequest.getProperties().containsKey("json"));
		//fire query
	...
	public void QueryTest_HandleStudIPRequests_GetServiceByLocationAndRole() {
		...
		System.out.println(!(list.get(0).getProperties().containsKey("HandleStudIPRequests")));
