...
// Diese Seite ist für das Einfuegen neuer Dienste aus dem StudIP heraus verantwortlich

// Zuerst Behandlung des Standardfalls, dass gerade kein Dienst eigegeben wurde
if ($action != "add"){ 
	echo'
		<form name="details" method="post" action="addService.php?action=add&scount=2">
...
//  Wenn das Formular abgeschickt wurde wird die Seite mit der $action add ausgeführt
else {
